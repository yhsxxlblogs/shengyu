    ...
    <view class="content-wrapper">
      ...
      <view v-else-if="!isLoggedIn" class="not-logged-in">
        <view class="empty-avatar">
          <svg-icon name="user" :size="80" color="#CCCCCC" />
        </view>
      ...
      <view v-else class="logged-in fade-in">
        <view class="user-card">
          <view class="user-header">
            ...
            <view class="edit-icon" @click="changeAvatar">
              <svg-icon name="camera" :size="24" color="#FFFFFF" />
            </view>
          </view>
        ...
        <view class="menu-section">
          ...
          <view class="menu-item" @click="myPosts">
            <view class="menu-icon-wrapper posts-bg">
              <svg-icon name="file" :size="28" color="#FFFFFF" />
            </view>
          ...
          <view class="menu-item" @click="mySounds">
            <view class="menu-icon-wrapper sounds-bg">
              <svg-icon name="music" :size="28" color="#FFFFFF" />
            </view>
          ...
          <view class="menu-item" @click="myLikes">
            <view class="menu-icon-wrapper likes-bg">
              <svg-icon name="heart" :size="28" color="#FFFFFF" />
            </view>
          ...
          <view class="menu-item" @click="goToFollows">
            <view class="menu-icon-wrapper follows-bg">
              <svg-icon name="users" :size="28" color="#FFFFFF" />
            </view>
          ...
          <view class="menu-item" @click="goToFollowers">
            <view class="menu-icon-wrapper followers-bg">
              <svg-icon name="star" :size="28" color="#FFFFFF" />
            </view>
        ...
        <view class="menu-section">
          ...
          <view class="menu-item" @click="settings">
            <view class="menu-icon-wrapper settings-bg">
              <svg-icon name="settings" :size="28" color="#FFFFFF" />
            </view>
          ...
          <view class="menu-item" @click="about">
            <view class="menu-icon-wrapper about-bg">
              <svg-icon name="info" :size="28" color="#FFFFFF" />
            </view>
...
/* 菜单图标背景色 */
.posts-bg { background: linear-gradient(135deg, #e0e7ff 0%, #c7b8f0 100%); }
.sounds-bg { background: linear-gradient(135deg, #fce4ec 0%, #f8bbd9 100%); }
.likes-bg { background: linear-gradient(135deg, #ffebee 0%, #ffcdd2 100%); }
.follows-bg { background: linear-gradient(135deg, #e3f2fd 0%, #bbdefb 100%); }
